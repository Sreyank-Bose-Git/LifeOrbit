...
export const DeviceIntegrationsModal: React.FC<DeviceIntegrationsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] overflow-y-auto bg-black/80 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4">
      <div className="bg-white/[0.02] rounded-3xl max-w-2xl w-full border border-white/10 shadow-2xl overflow-hidden">
          ...
          <div className="space-y-3">
            {connectors.map((c) => {
              ...
              return (
                <div
                  key={c.id}
                  className="bg-white/[0.04] rounded-2xl p-4 border border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-white/10 transition"
                >
